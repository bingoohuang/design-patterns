...
import oom.github.bingoohuang.designpatterns.commands.DelCommand;
import oom.github.bingoohuang.designpatterns.User;

import java.util.Map;

public class DelCommandParser implements oom.github.bingoohuang.designpatterns.CommandParser {
    @Override
